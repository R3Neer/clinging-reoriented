...
public final class GravityFallFullSphereClientGameTest implements FabricClientGameTest {
    ...
    @Override public void runTest(ClientGameTestContext context){
        ...
        try(var world=context.worldBuilder().create()){
            ...
            // Entity.turn multiplies mouse pitch by 0.15; 800 therefore asks for +120 degrees.
            context.runOnClient(mc->{
            ...
            context.runOnClient(mc->{
                mc.player.turn(0.0D,800.0D);
                // +240 is normalized to -120 while xRotO receives the same 360-degree shift.
            ...
            // Exit reproduction. Leave the camera beyond vanilla's neck range and stop Gravity Fall;
            // this checkpoint tells the next TM iteration whether release needs an explicit unwind.
            context.runOnClient(mc->{
                mc.player.turn(0.0D,800.0D);
