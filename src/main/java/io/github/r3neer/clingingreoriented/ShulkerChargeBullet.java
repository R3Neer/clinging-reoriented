 ...
 * cardinal velocity selected by the Shulker Charge initializer.
 */
public final class ShulkerChargeBullet extends ShulkerBullet {
    public ShulkerChargeBullet(Level level){super(EntityTypes.SHULKER_BULLET,level);}
