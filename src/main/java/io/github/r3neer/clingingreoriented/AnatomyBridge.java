...
public final class AnatomyBridge {
    ...
    public static void initialize() {
        ...
        try {
            ...
            catch(ClassNotFoundException oldVersion){return;}
            var frame=Class.forName("io.github.r3neer.scalebrews.platform.anatomy.GravityFrame").getConstructor(Direction.class);
            var frames=Class.forName("io.github.r3neer.scalebrews.platform.anatomy.GravityFrames");
            var parent=Class.forName("io.github.r3neer.scalebrews.platform.anatomy.AnatomyMovement$Contact").getMethod("support");
            var candidate=new Api(core.getMethod("active",Entity.class),core.getMethod("clear",Entity.class),core.getMethod("contact",Entity.class),
                core.getMethod("supported",Entity.class),core.getMethod("spaceClear",Entity.class,AABB.class),parent);
            Function<Entity,Object> resolver=entity->{try{return frame.newInstance(GravityDirectionUtil.getGravityDirection(entity));}
            ...
            api=candidate;
        }catch(ReflectiveOperationException failure){throw new IllegalStateException("Incompatible Scale Brews anatomical API",failure);}
    }
    ...
    public static LivingEntity parent(Entity entity){if(api==null)return null;var contact=call(api.contact(),null,entity);return contact==null?null:(LivingEntity)call(api.parent(),contact);}
}
