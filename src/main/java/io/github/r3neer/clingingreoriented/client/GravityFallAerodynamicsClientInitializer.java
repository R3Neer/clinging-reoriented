...
public final class GravityFallAerodynamicsClientInitializer implements ClientModInitializer {
    ...
    @Override public void onInitializeClient(){
        ClientTickEvents.END_CLIENT_TICK.register(client->{
            ...
            look=look.normalize();
            // LocalPlayer.zza is vanilla's signed forward/back movement impulse. Only positive W
            // participates in momentum redirection; S remains ordinary Minecraft air control.
