...
public final class GravityFallAerodynamicsClientInitializer implements ClientModInitializer {
    ...
    @Override public void onInitializeClient(){
        ClientTickEvents.END_CLIENT_TICK.register(client->{
            ...
            if(lookChanged||ticksSinceSend>=HEARTBEAT_TICKS){
                // forwardIntent remains on the wire for protocol continuity but no longer gates physics.
                ClientPlayNetworking.send(new GravityFallLookSync.Look(++sequence,look,0.0F));
