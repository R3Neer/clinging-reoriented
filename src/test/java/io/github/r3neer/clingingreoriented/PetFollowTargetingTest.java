...
final class PetFollowTargetingTest {
    ...
    @Test void airborneDistanceIgnoresOnlyCandidateGravityAxis(){
        ...
        assertEquals(13.0D,PetFollowTargeting.goalDistance(p,ANCHOR,Direction.EAST,true),1.0E-9D);
        assertEquals(13.0D,PetFollowTargeting.goalDistance(p,ANCHOR,Direction.WEST,true),1.0E-9D);
