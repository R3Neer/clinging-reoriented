# GC-S03 — Navegación, impacto, redstone y recaptura

Estado: **CERRADO / GATE VERDE**.

> Nota de canonización beta.1: la denominación provisional del desarrollo se sustituyó por **Gravity Charge** antes de la primera publicación.

## Scope cerrado

GC-S03 cubre navegación cardinal de la Gravity Charge lanzada, impactos físicos, Target Block/redstone, daño y Levitation vanilla, recaptura y compatibilidad con la duplicación vanilla de shulkers.
...
- los escenarios de bloque usan coordenadas mundo absolutas una sola vez, evitando mezclar transformaciones relativas de GameTest con navegación cardinal;
...
- el shulker de duplicación se mantiene físicamente anclado sobre soporte sólido hasta el impacto. El antiguo fixture flotaba, ejecutaba un teleport ambiental antes de recibir la Gravity Charge y llegaba cerrado a `hitByShulkerBullet()`, produciendo un falso negativo.

## Evidencia

- HEAD funcional histórico limpio: `986f1196751f54ad94bd3509eaa644b8a771ef58`.
...
- El mismo conjunto volvió a pasar en run #626 después de añadir únicamente evidencia visual S04.
...
Deuda trasladada: carreras combinadas, lifecycle y stress/concurrencia pertenecen a GC-S05, no reabren GC-S03 salvo regresión real.
